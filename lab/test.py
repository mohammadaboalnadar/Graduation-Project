...
model = PPO.load(r"D:\Files\Scripts\py\Graduation Project\Models\checkpoints\v9.7s1.0\3000000_steps.zip")
...
env = VecNormalize.load(r"D:\Files\Scripts\py\Graduation Project\Models\checkpoints\v9.7s1.0\3000000_steps_vecnorm.pkl", venv)
